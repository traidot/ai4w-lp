const SIDE_SOLUTIONS = [
  {
    ...
    title: "Bán lẻ (Retail)",
    description:
      "Quản lý kho thông minh, dự báo hàng tồn và tích hợp vận chuyển GHN/AhaMove tức thì.",
  },
  {
    icon: "campaign",
    ...
    description:
      "Quản lý dự án tập trung, tự động hóa báo cáo và phân bổ nguồn lực Agent hiệu quả.",
  },
];
    ...
    >
      <div className="max-w-[1440px] mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-14">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center text-white/80 hover:bg-white/10 hover:text-white transition-colors"
            >
              <span className="material-symbols-outlined">chevron_left</span>
            </button>
            <button
              aria-label="Giải pháp tiếp theo"
              className="w-12 h-12 rounded-full bg-primary flex items-center justify-center text-on-primary hover:brightness-110 transition-all"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          <div className="lg:col-span-7 rounded-3xl overflow-hidden relative h-[400px] lg:h-[500px] group shadow-2xl">
            <img
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            {SIDE_SOLUTIONS.map((item) => (
              <div
                key={item.title}
                className="group flex-1 bg-white/[0.05] p-8 rounded-3xl border border-white/10 hover:bg-white/[0.08] hover:border-white/20 transition-all cursor-pointer flex flex-col justify-center"
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="material-symbols-outlined ml-auto text-white/40 transition-all duration-300 group-hover:text-white group-hover:translate-x-1">
                    arrow_forward
                  </span>
                </div>
